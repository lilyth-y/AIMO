# MathCodeOrchestrator Reference Problem Evaluation

MathCodeOrchestrator Progress Prize 3 참조 문제 5개를 평가하는 스크립트입니다.
...
docker compose run --rm -e MathCodeOrchestrator_FAST_TEST=1 aimo_reference
```
...
MathCodeOrchestrator 3 Kaggle 제출 형식:
```csv
id,answer
0e644e,336
26de63,32951
