...
# Diagnostic script: check AIMO_MODEL env and attempt to load HF pipeline
import os, traceback, sys

model = os.getenv('AIMO_MODEL', 'models--Qwen--Qwen2.5-Math-72B-Instruct').strip()
quant = os.getenv('AIMO_QUANTIZATION', None)
print('AIMO_MODEL:', model)
print('AIMO_QUANTIZATION:', quant)
