...
def main():
    ...
    # Note: In Kaggle, you might need to set AIMO_MODEL to a local path of the uploaded dataset
    # e.g. os.environ['AIMO_MODEL'] = '/kaggle/input/qwen2-5-math-1-5b-instruct'
